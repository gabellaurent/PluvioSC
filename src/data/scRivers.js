 ...
 * rios principais e cotas de referência fluviométrica (em metros).
 */
...
export const CITY_RIVER_MAPPING = {
  florianopolis: {
    ...
    normalGaugeHeight: 1.2,
    attentionGaugeHeight: 2.5,
    emergencyGaugeHeight: 3.5
  },
  blumenau: {
  ...
  joinville: {
    ...
    normalGaugeHeight: 1.1,
    attentionGaugeHeight: 2.2,
    emergencyGaugeHeight: 3.2
  },
  chapeco: {
    ...
    normalGaugeHeight: 3.0,
    attentionGaugeHeight: 7.0,
    emergencyGaugeHeight: 11.0
  },
  riodosul: {
    ...
    normalGaugeHeight: 2.0,
    attentionGaugeHeight: 5.5,
    emergencyGaugeHeight: 8.0
  },
  criciuma: {
    ...
    normalGaugeHeight: 1.3,
    attentionGaugeHeight: 2.8,
    emergencyGaugeHeight: 4.0
  },
  lages: {
    ...
    normalGaugeHeight: 1.6,
    attentionGaugeHeight: 3.2,
    emergencyGaugeHeight: 5.0
  },
  itajai: {
  ...
  jaraguadosul: {
    ...
    attentionGaugeHeight: 3.0,
    emergencyGaugeHeight: 4.8
  },
  tubarao: {
    ...
    normalGaugeHeight: 1.5,
    attentionGaugeHeight: 3.5,
    emergencyGaugeHeight: 5.5
  },
  saojose: {
  ...
  canoinhas: {
    ...
    normalGaugeHeight: 1.7,
    attentionGaugeHeight: 4.0,
    emergencyGaugeHeight: 6.0
  }
};
...
export function getRiverMetadata(cityId, cityName) {
  ...
  return {
    ...
    description: `Monitoramento de descarga e nível fluviométrico na região de ${cityName}.`,
